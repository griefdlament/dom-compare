(function(){
   ...
   function Comparator(options, collector, attribute, element) {
      ...
      if(ignore)
        this._loadExcludeConfigFile(element, ignoreChildNodeDetail);
   }
   ...
   module.exports = function(a, b, options, attribute, element) {


      var collector = new Collector(options);
      var comparator = new Comparator(options, collector, attribute, element);
